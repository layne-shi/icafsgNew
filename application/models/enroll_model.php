...
class Enroll_model extends CI_Model
{
            ...
            foreach ($directarr as $k1 => $direct)
            {
                foreach ($direct as $direct_id => $item)
                {
                    ...
                    $saveData[] = array(
                        ...
                        'song2' => isset($item['song2'])?$item['song2']:'',
                        'composer2' => isset($item['composer2'])?$item['composer2']:'',
                        'author2' => isset($item['author2'])?$item['author2']:'',
                        'song3' => isset($item['song3'])?$item['song3']:'',
                        'composer3' => isset($item['composer3'])?$item['composer3']:'',
                        'author3' => isset($item['author3'])?$item['author3']:'',
    ...
    public function getEnrollList($getwhere = array(),$pagenum = "0",$exnum = "0")
    {
        ...
        d.song AS song,d.composer AS composer,d.author AS author,
        d.song2 AS song2,d.composer2 AS composer2,d.author2 AS author2,
        d.song3 AS song3,d.composer3 AS composer3,d.author3 AS author3,
